...
namespace :bundle do
  search_path = 'sources/packages/search.replaplugin/contents/resources/test/rakefile'
  search_test_rakefile = File.join(File.dirname(__FILE__), search_path)
  load search_test_rakefile
  task test_search: ['search:tests']

  html_path = 'sources/packages/HTML.replaplugin/contents/resources/test/rakefile'
  ...
  server_path = 'sources/packages/Server.replaplugin/contents/resources/test/rakefile'
